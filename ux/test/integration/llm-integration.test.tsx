...
describe('LLM Service Integration', () => {
  it('should export LLM service with all methods', () => {
    ...
    expect(llmService.generateDefinitionWithComponents).toBeInstanceOf(Function);
    expect(llmService.generateDefinitionWithReferences).toBeInstanceOf(Function);
  ...
  it('should validate required parameters in service methods', async () => {
    await expect(llmService.suggestDefinition({ term: '' }))
