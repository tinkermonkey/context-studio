...
export const useExternalPredicates = (..._args: any[]): any => {
  throw new Error("useExternalPredicates has been removed.");
};

export const useSimilarPredicates = (..._args: any[]): any => {
  throw new Error("useSimilarPredicates has been removed.");
};

export const useSearchExternalPredicates = (..._args: any[]): any => {
  throw new Error("useSearchExternalPredicates has been removed.");
};
