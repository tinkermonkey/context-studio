...
export const useGraphStats = (
  options?: UseQueryOptions<GraphStats, Error>
) => {
  return useQuery({
...
export const useRelatedTerms = (
  ...
  return useQuery({
    queryKey: createQueryKey(QUERY_KEYS.GRAPH, `related-terms-${termId}`, params ? { ...params } : undefined),
...
export const useDomainHierarchy = (
  ...
  return useQuery({
    queryKey: createQueryKey(QUERY_KEYS.GRAPH, 'domain-hierarchy', params ? { ...params } : undefined),
...
export const useLayerAnalytics = (
  ...
  return useQuery({
    queryKey: createQueryKey(QUERY_KEYS.GRAPH, 'layer-analytics', params ? { ...params } : undefined),
...
export const useCommunityDetection = (
  ...
  return useQuery({
    queryKey: createQueryKey(QUERY_KEYS.GRAPH, 'communities', params ? { ...params } : undefined),
...
export const useRdfExport = (
  ...
  return useQuery({
    queryKey: createQueryKey(QUERY_KEYS.GRAPH, 'rdf-export', params ? { ...params } : undefined),
...
export const useGraphExport = (
  ...
  return useQuery({
    queryKey: createQueryKey(QUERY_KEYS.GRAPH, 'graph-export', params ? { ...params } : undefined),
