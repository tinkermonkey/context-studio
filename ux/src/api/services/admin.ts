...
type BackgroundTaskSummaryResponse =
...
class AdminService extends BaseService {
  ...
  async getTaskSummary(): Promise<BackgroundTaskSummaryResponse> {
    return this.get<BackgroundTaskSummaryResponse>(
  ...
  async updateConfigSection(
    ...
    return this.patch<AppConfigurationResponse>(
  ...
  async resetConfig(): Promise<AppConfigurationResponse> {
    return this.post<AppConfigurationResponse>(
