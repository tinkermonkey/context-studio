...
export class NodeLinkService extends BaseService {
   ...
   */
  async list(params?: StructureNodeLinkListParams): Promise<StructureNodeLink[]> {
    return this.withErrorContext(async () => {
      ...
      if (params?.source_node_id) queryParams.source_node_id = params.source_node_id;
      if (params?.target_node_id) queryParams.target_node_id = params.target_node_id;
   ...
   */
  async listPage(params?: StructureNodeLinkListParams): Promise<StructureNodeLink[]> {
    return this.withErrorContext(async () => {
      const url = ENDPOINTS.NODE_LINKS + '/';
   ...
   */
  async listPageWithMetadata(params?: StructureNodeLinkListParams): Promise<PaginatedResponse<StructureNodeLink>> {
    return this.withErrorContext(async () => {
      const url = ENDPOINTS.NODE_LINKS + '/';
  ...
  async get(id: string): Promise<StructureNodeLink> {
    return this.withErrorContext(async () => {
      ...
      return this.getResource<StructureNodeLink>(`${ENDPOINTS.NODE_LINKS}/${id}`);
    }, 'get');
  }
  ...
  async create(data: StructureNodeLinkCreate): Promise<StructureNodeLink> {
    return this.withErrorContext(async () => {
      ...
      return this.postResource<StructureNodeLink>(ENDPOINTS.NODE_LINKS + '/', data);
    }, 'create');
  }
   ...
   */
  async getLinksBetweenNodes(sourceId: string, targetId: string): Promise<StructureNodeLink[]> {
    return this.withErrorContext(async () => {
