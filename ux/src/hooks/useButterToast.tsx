  ...
  const showToast = useCallback(
    ({ type, message, duration = 5000 }: ToastOptions) => {
      ...
      if (root) {
        ...
        // Build the toast structure safely without directly interpolating user content
        ...
        messageDiv.textContent = message; // Use textContent to safely set user-provided text
        ...
        closeButton.onclick = () => toastWrapper.remove();
