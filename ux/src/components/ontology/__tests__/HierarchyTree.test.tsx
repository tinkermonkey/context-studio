...
const classes: ClassResponse[] = [
  ...
  {
    id: "class-3",
    concept_scheme_id: "scheme-2",
    taxonomy_id: "tax-1",
    identifier: "class_three",
    title: "Class Three",
...
describe("HierarchyTree", () => {
  describe("structure", () => {
    ...
    it("uses the default domain swatch for all rows", () => {
      ...
      expect(screen.getByTestId("hierarchy-node-class-1")).toHaveAttribute(
        "data-domain",
        "default",
      );
    });
  ...
  describe("class selection", () => {
    ...
    it("marks the selected class row", async () => {
      ...
      renderTree();
      await user.click(screen.getByTestId("hierarchy-node-class-1"));
      expect(screen.getByTestId("hierarchy-node-class-1").className).toContain(
