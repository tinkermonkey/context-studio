...
describe("RelationshipForm", () => {
  ...
  const mockClasses: components["schemas"]["ClassResponse"][] = [
    { id: "class-1", title: "Class 1", created_at: "", updated_at: "" },
    { id: "class-2", title: "Class 2", created_at: "", updated_at: "" },
  ];
  const mockProperties: components["schemas"]["PropertyDefinitionResponse"][] = [
    { id: "prop-1", identifier: "prop_1", title: "Property 1", created_at: "", updated_at: "" },
    { id: "prop-2", identifier: "prop_2", title: "Property 2", created_at: "", updated_at: "" },
  ];
