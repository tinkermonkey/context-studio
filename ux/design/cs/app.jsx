...
function CSApp() {
  ...
  const paletteCommands = useMemo(() => [
    { id: 'go-dashboard',     label: 'Go to Dashboard',        description: 'Workspace overview',                icon: 'dashboard', onSelect: () => navigate('dashboard') },
    { id: 'go-classes',       label: 'Go to Classes',          description: '/schema/classes',                   icon: 'schema',    onSelect: () => navigate('schema/classes') },
    { id: 'go-taxonomies',    label: 'Go to Taxonomies',       description: '/schema/taxonomies',                icon: 'schema',    onSelect: () => navigate('schema/taxonomies') },
    { id: 'go-properties',    label: 'Go to Properties',       description: '/schema/properties',                icon: 'component', onSelect: () => navigate('schema/properties') },
    { id: 'go-relationships', label: 'Go to Relationships',    description: '/schema/relationships',             icon: 'link',      onSelect: () => navigate('schema/relationships') },
    { id: 'go-individuals',   label: 'Go to Individuals',      description: '/data/individuals',                 icon: 'data',      onSelect: () => navigate('data/individuals') },
    { id: 'go-pipelines',     label: 'Go to Pipelines',        description: '/pipelines/all',                    icon: 'pipeline',  onSelect: () => navigate('pipelines/all') },
    { id: 'go-graph',         label: 'Go to Graph view',       description: 'Inferred KG layout',                icon: 'graph',     onSelect: () => navigate('graph') },
    { id: 'new-class',        label: 'New class…',             description: 'Open the new-class modal',          icon: 'plus',      onSelect: () => setNewClassOpen(true) },
    { id: 'new-pipeline-run', label: 'Run pipeline…',          description: 'Trigger a pipeline run',            icon: 'pipeline',  onSelect: () => setToast({ variant:'info', title:'Pipeline scheduled', subtitle:'pubmed_genes · next slot' }) },
  ], [route]);
