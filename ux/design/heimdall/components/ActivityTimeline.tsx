type ActivityEventType = "create" | "update" | "delete" | "run";
          ...
          {events.map((event) => (
            <div
              ...
              className={[
                ...
                event.onClick ? "activity-timeline__event--clickable" : "",
              ]
                .filter(Boolean)
                .join(" ")}
            ...
            >
              <div className="activity-timeline__dot-container">
                {event.dotColor ? (
                  ...
                  <Badge
                    color={EVENT_COLOR_MAP[event.type]}
              ...
              <div className="activity-timeline__content">
                <div className="activity-timeline__header">
                  {event.kind && (
                    <span
                      className="activity-timeline__kind-label"
                      data-testid={`activity-kind-tag-${event.id}`}
                    >
