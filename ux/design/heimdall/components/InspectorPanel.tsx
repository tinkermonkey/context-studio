...
interface InspectorPanelSectionProps extends React.HTMLAttributes<HTMLDivElement> {
  title: string;
  count?: number;
  actions?: ReactNode;
  children?: ReactNode;
...
interface InspectorPanelPropertySectionProps extends React.HTMLAttributes<HTMLDivElement> {
  title: string;
  count?: number;
...
const InspectorPanelPropertySection = React.forwardRef<
  HTMLDivElement,
  InspectorPanelPropertySectionProps
...
const InspectorPanelComponent = React.forwardRef<HTMLDivElement, InspectorPanelProps>(
  ({ eyebrow = "", title, id, version, actions, children, className = "", ...props }, ref) => {
...
const InspectorPanel = Object.assign(InspectorPanelComponent, {
