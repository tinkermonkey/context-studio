...
type HierarchyKind = 'taxonomy' | 'scheme' | 'class'
type HierarchyDomain = 'life' | 'climate' | 'software' | 'default' | (string & {})

interface HierarchyRowProps extends React.HTMLAttributes<HTMLDivElement> {
  depth?: number
...
const HierarchyRow = React.forwardRef<HTMLDivElement, HierarchyRowProps>(
  (
    {
      depth = 0,
      domain,
...
window.HierarchyRow = HierarchyRow;
