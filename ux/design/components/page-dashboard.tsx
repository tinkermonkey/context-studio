    ...
    <div className="canvas-inner" data-screen-label="01 Dashboard">
        ...
        <div>
          <div className="page-head-meta">
            ...
            <span className="muted mono" style={{ fontSize: 11 }}>
              last sync {D.workspace.last_sync}
            </span>
            <span className="muted mono" style={{ fontSize: 11 }}>
              ·
            </span>
            <span className="muted mono" style={{ fontSize: 11 }}>
              graph daemon healthy
            </span>
          </div>
          <h1>
            Dashboard <span className="id-tag">/workspace/{D.workspace.name}</span>
          </h1>
          <div className="subtitle">
            Curate knowledge graphs for retrieval-augmented generation and agents. Taxonomies group
            concept schemes; concept schemes hold classes; classes hold individuals.
          </div>
        </div>
      ...
      <div className="stat-grid" style={{ marginBottom: 18 }}>
        <StatTile
          ...
          meta={
            <>
              <span className="muted">3 active · 0 archived</span>
            </>
          }
          sparkData={D.sparks.taxonomies}
          sparkColor="#22D3EE"
        />
        <StatTile
          label="Classes"
          ...
          meta={
            <>
              <span className="delta-up">▲ 4</span> <span className="muted">this week</span>
            </>
          }
          sparkData={D.sparks.classes}
          sparkColor="#A78BFA"
        />
        <StatTile
          label="Individuals"
          ...
          meta={
            <>
              ...
              <span className="muted">last run · 412 ingested</span>
            </>
          }
          sparkData={D.sparks.individuals}
          sparkColor="#10B981"
        />
        <StatTile
          label="Pipelines"
          ...
          meta={
            <>
              <span className="pulse sm amber"></span>
              <span className="muted">1 running · {failedPipelines} failed</span>
            </>
          }
          sparkData={D.sparks.ingestRate}
          sparkColor="#FBBF24"
        />
      </div>
      ...
      <div className="panel" style={{ marginBottom: 18 }}>
        <div className="panel-head">
          ...
          <div className="row gap-12">
            <span className="muted mono" style={{ fontSize: 11 }}>
              {runningPipelines} running · {D.pipelines.length - runningPipelines} idle
            </span>
            <button className="btn btn-ghost btn-sm" onClick={() => onNav("pipelines/all")}>
              All pipelines <Icon name="arrow" size={11} />
            </button>
          </div>
        </div>
        <div
