...
function App() {
  ...
  const navigate = (r) => { setRoute(r); setPaletteOpen(false); setWsOpen(false); };
  ...
  const Page = (() => {
    ...
    if (route.startsWith("schema/")) return <SchemaPage route={route} onNav={navigate} onOpenNewClass={() => setNewClassOpen(true)} />;
    ...
    <div className="desktop">
      <div className="app-shell">
        ...
        <div className="workspace">
          <Topbar route={route} onPalette={() => setPaletteOpen(true)} onSwitchWs={() => setWsOpen(true)} />
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <button className="btn btn-ghost" onClick={() => setNewClassOpen(false)}>Cancel</button>
            <button className="btn btn-primary" onClick={() => {
              setNewClassOpen(false);
              pushToast({ kind: "success", title: "Class created", subtitle: "cls_neuron_motor · sch_cell_bio" });
            }}>Create class</button>
          </>
        }
      >
        <div className="field">
          <div className="lab">Identifier<span className="hint-r">snake_case · required</span></div>
          <input className="input mono" defaultValue="cls_neuron_motor" autoFocus />
          <div className="hint">Must match <span className="mono">/^cls_[a-z][a-z0-9_]*$/</span></div>
        </div>
        <div className="field">
        ...
        <div className="field">
          ...
          <select className="select" style={{width: "100%", fontFamily: "var(--font-mono)", fontSize: 12.5}}>
        ...
        <div className="field">
          <div className="lab">Parent class<span className="hint-r">optional</span></div>
          <select className="select" style={{width: "100%", fontFamily: "var(--font-mono)", fontSize: 12.5}}>
        ...
        <div className="field">
          ...
          <textarea className="input" rows={3} defaultValue="Motor neurons carry signals from the central nervous system to muscle fibers." />
        </div>
      </Modal>
