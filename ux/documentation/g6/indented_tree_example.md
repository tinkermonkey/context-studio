# Indented Tree Example

## Non-react example

Below is a non-react example of the indented tree graph

[Source](https://g6.antv.antgroup.com/en/examples/scene-case/tree-graph#indented-tree)
