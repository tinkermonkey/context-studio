...
This module implements the version management API endpoints for entity versioning,  # noqa: E501
working tree state management, diff generation, and rollback capabilities.

Endpoints:
- GET /api/versions/entities/{entity_type}/{entity_id}/versions - Get version history for an entity  # noqa: E501
- GET /api/versions/entities/{entity_type}/{entity_id}/versions/{version_number} - Get specific version  # noqa: E501
- POST /api/versions/entities/{entity_type}/{entity_id}/rollback - Rollback entity to specific version  # noqa: E501
- GET /api/versions/entities/{entity_type}/{entity_id}/diff - Get working diff for entity  # noqa: E501
...
def get_entity_versions(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to retrieve versions: {e!s}"
        )
...
def get_entity_version(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to retrieve version: {e!s}"
        )
...
def rollback_entity(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Rollback failed: {e!s}"
        )
...
def get_working_diff(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to generate diff: {e!s}"
        )
...
def get_working_tree_status(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get working tree status: {e!s}"
        )
...
def get_working_changes(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get working changes: {e!s}"
        )
...
def stage_entity(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to stage entity: {e!s}"
        )
...
def unstage_entity(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to unstage entity: {e!s}"
        )
...
def commit_staged_changes(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to commit changes: {e!s}"
        )
...
def get_commit_preview(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to generate commit preview: {e!s}"
        )
...
def get_all_working_diffs(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to generate working diffs: {e!s}"
        )
...
def compare_versions(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to compare versions: {e!s}"
        )
...
def get_version_management_health(
    ...
    try:
        ...
        orphaned_versions = db.execute(text("""
            ...
            LEFT JOIN entity_versions parent ON ev.parent_version_id = parent.id  # noqa: E501
...
def get_version_management_stats(
    ...
    try:
        ...
        recent_results = db.execute(text("""
            SELECT entity_type, entity_id, version_number, state, author_id, created_at  # noqa: E501
            FROM entity_versions
...
def _entity_diff_to_out(diff) -> EntityDiffOut:
    ...
    if hasattr(diff, "summary") and isinstance(diff.summary, dict):
        ...
        summary = DiffSummaryOut(
            ...
            + summary_data.get("iterable_item_added", 0),
            removed_items=summary_data.get("dictionary_item_removed", 0)
            + summary_data.get("iterable_item_removed", 0),
