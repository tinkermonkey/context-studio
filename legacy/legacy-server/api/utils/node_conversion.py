...
import numpy as np
from api.models.structure_nodes import NodeLinkOut, NodeOut, NodeTypeEnum
...
def to_node_out(
    ...
    try:
        ...
        error_msg = (
            f"Invalid structure_node ID: {structure_node.id!r} "
    ...
    return NodeOut(
        ...
        ),  # Convert to legacy NodeTypeEnum
        parent_node_id=(
...
def uuid_to_str(uuid_val: UUID | None) -> str | None:
    """
