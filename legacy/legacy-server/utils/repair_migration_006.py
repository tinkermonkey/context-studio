#!/usr/bin/env python3
"""
Repair script for Migration 006 - fixes databases where migration 006 was marked as complete  # noqa: E501
...
3. Re-runs the data migration if legacy tables have data but structure_nodes is empty  # noqa: E501
