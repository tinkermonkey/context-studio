...
class TestPerformanceMonitor:
        ...
        def create_cursor():
            ...
            cursor.fetchone.side_effect = [
                (
                    ...
                    45,
                    12,
                ),  # total_objects, table_count, index_count from stats query
    ...
    def test_performance_thresholds_configuration(self, performance_monitor):
        ...
        expected_thresholds = [
            ...
            "s3_metrics.avg_sync_time_ms",
            "system_metrics.memory_usage_mb",
            "system_metrics.error_rate_percent",
            "batch_metrics.avg_throughput_per_second",
    ...
    def test_system_metrics_collection_with_psutil(self, performance_monitor):
        ...
        with patch("psutil.cpu_percent", return_value=25.5), patch(
            ...
            mock_disk.return_value = Mock(
                used=53687091200, free=429496729600  # 50GB  # 400GB
            )
    ...
    def test_system_metrics_fallback_without_psutil(self, performance_monitor):
        ...
        with patch(
            "psutil.cpu_percent", side_effect=ImportError("psutil not available")
        ):
            metrics = performance_monitor.collect_performance_metrics()
            system_metrics = metrics["system_metrics"]
    ...
    def test_performance_alert_generation(self, performance_monitor):
        ...
        memory_threshold = performance_monitor.performance_thresholds[
            "system_metrics.memory_usage_mb"
        ]
        ...
        high_performance_metrics = {
            ...
            },  # Above 10000ms threshold
            "system_metrics": {
                "memory_usage_mb": memory_threshold
                * 1.2,  # 20% above the dynamic threshold
    ...
    def test_optimization_cooldown(self, performance_monitor):
        ...
        performance_monitor.last_optimization_time = (
            time.time() - 1800
        )  # 30 minutes ago
    ...
    def test_optimization_actions(self, performance_monitor):
        ...
        with patch.object(
            performance_monitor, "_is_metric_above_threshold", return_value=True
        ):
    ...
    def test_materialized_view_refresh(self, performance_monitor):
        ...
        with patch.object(
            performance_monitor, "_are_materialized_views_stale", return_value=True
        ):
    ...
    def test_cache_optimization(self, performance_monitor):
        ...
        with patch.object(
            performance_monitor, "_is_metric_below_threshold", return_value=True
        ):
    ...
    def test_health_score_calculation(self, performance_monitor):
        ...
        trends = {
            "query_time_trend": {
                "current_value": 1000
            },  # Excellent performance (1s vs 10s max)
            "memory_usage_trend": {
                "current_value": 100
            },  # Excellent memory usage (100MB vs 1000MB max)
    ...
    def test_issue_identification(self, performance_monitor):
        ...
        trends = {
            ...
            "memory_usage_trend": {"trend": "increasing", "current_value": 900},
            "error_rate_trend": {"current_value": 1.5, "trend": "increasing"},
            "cache_hit_rate_trend": {"current_value": 0.65, "trend": "decreasing"},
        }
    ...
    def test_optimization_recommendations(self, performance_monitor):
        ...
        trends = {"query_time_trend": {"current_value": 7000, "trend": "increasing"}}

        issues = [{"type": "query_performance_degradation", "current_value": 7000}]

        recommendations = performance_monitor._generate_optimization_recommendations(
            trends, issues
        )
