...
def get_mock_kg_context_output(num_phrases=2, num_nodes=3):
    ...
    from rag.processors.models import ExtractedPhrase, KGContextOutput, KGNode
...
def get_mock_llm_extraction_output(num_entities=2):
    ...
    from rag.processors.models import ExtractedEntity, LLMExtractionOutput
...
def get_mock_spacy_gap_output(num_gaps=1):
    ...
    from rag.processors.models import GapConcept, GapPriority, SpaCyGapOutput
