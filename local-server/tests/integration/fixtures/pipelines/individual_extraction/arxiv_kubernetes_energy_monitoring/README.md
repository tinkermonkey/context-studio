# Arxiv Kubernetes Energy Monitoring Fixture

**Source:** Arxiv-style research-paper abstract about process-level energy attribution for Nextflow workflows on Kubernetes (Nf-PEAK), originally bundled as an unused NLP-pipeline test fixture (specific paper/authors not attributed in the source fixture).
**Promoted from:** `fixture_kubernetes_energy_monitoring.json` (arxiv-domain fixture unused by any test,
