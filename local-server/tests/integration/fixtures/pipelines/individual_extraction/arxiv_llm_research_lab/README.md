# Arxiv LLM Research Lab Fixture

**Source:** Synthetic industry fixture describing publicly known facts about OpenAI and GPT-4, originally bundled as an unused NLP-pipeline test fixture.
**Promoted from:** `fixture_paper_4.json` (arxiv-domain fixture unused by any test,
