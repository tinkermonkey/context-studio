# Arxiv Cloud Platform Landscape Fixture

**Source:** Synthetic industry-landscape fixture describing publicly known cloud platforms, originally bundled as an unused NLP-pipeline test fixture.
**Promoted from:** `fixture_paper_3.json` (arxiv-domain fixture unused by any test,
