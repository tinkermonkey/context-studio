# Arxiv Consensus Protocol Collaboration Fixture

**Source:** Synthetic academic-collaboration fixture (placeholder subject 'John Doe'; not a real person or paper) originally bundled as an unused NLP-pipeline test fixture.
**Promoted from:** `fixture_paper_5.json` (arxiv-domain fixture unused by any test,
