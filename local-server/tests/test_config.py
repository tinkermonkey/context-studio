...
class TestConfigurationManager:
    """
    Test-isolated configuration manager that prevents pollution of global config files.
    
    Uses temporary directories and files to ensure complete isolation between tests
    ...
    def get_test_settings(self, overrides: Optional[Dict[str, Any]] = None) -> Settings:
        """
...
def create_test_settings(temp_dir: str, overrides: Optional[Dict[str, Any]] = None) -> Settings:
    """
...
def patch_config_manager_for_tests(temp_dir: str, overrides: Optional[Dict[str, Any]] = None) -> TestConfigurationManager:
    """
