...
class TestLLMTraceabilityIntegration:
    ...
    def test_full_execution_tracking_flow(self, mock_get_session):
        ...
        assert details["execution"]["pipeline_type"] == "suggest_term_definition"  # noqa: E501
    ...
    def test_selection_tracking_flow(self, mock_get_session):
        ...
        assert selection["selected_content"] == "A test is a procedure for evaluation."  # noqa: E501
    ...
    def test_error_scenarios(self, mock_get_session):
        ...
        with pytest.raises(ValueError, match="Execution nonexistent-execution not found"):  # noqa: E501
            tracker.record_selection(selection_request)
    ...
    def test_concurrent_executions(self, mock_get_session):
        ...
        for i in [2, 0, 1]:  # Complete out of order
            tracker.complete_execution(
                ...
                success=True,
                token_usage={"input_tokens": 5, "output_tokens": 10, "total_tokens": 15}  # noqa: E501
            )
    ...
    def test_database_schema_creation(self):
        ...
        with engine.connect() as conn:
            ...
            for expected_index in expected_indexes:
                assert expected_index in indexes, f"Missing index: {expected_index}"  # noqa: E501
    ...
    def test_get_execution_history_endpoint(self, mock_get_session):
        ...
        for i in range(2):
            ...
            tracker.complete_execution(
                ...
                success=True,
                token_usage={"input_tokens": 8, "output_tokens": 12, "total_tokens": 20}  # noqa: E501
            )

        # Test getting execution history for flavor-1
        history_flavor_1 = tracker.get_flavor_execution_history("flavor-1", limit=10)  # noqa: E501
        ...
        assert set(execution_ids) == set(flavor_1_executions)  # All executions present  # noqa: E501

        # Test getting execution history for flavor-2
        history_flavor_2 = tracker.get_flavor_execution_history("flavor-2", limit=10)  # noqa: E501
        assert history_flavor_2["flavor_id"] == "flavor-2"
        assert history_flavor_2["total_count"] == 2
        assert len(history_flavor_2["executions"]) == 2

        # Test with limit
        limited_history = tracker.get_flavor_execution_history("flavor-1", limit=1)  # noqa: E501
        ...
        empty_history = tracker.get_flavor_execution_history("nonexistent-flavor")  # noqa: E501
    ...
    def test_get_flavor_analytics_endpoint(self, mock_get_session):
        ...
        for i in range(4):
            test_request = Mock()
            test_request.model_dump.return_value = {"term": f"analytics_test{i}"}  # noqa: E501
            ...
            tracker.complete_execution(
                execution_id=execution_id,
                response_message=f"Response for analytics_test{i}" if success else "",  # noqa: E501
                success=success,
                error_message="Test error" if not success else None,
                token_usage={"input_tokens": 10, "output_tokens": 15, "total_tokens": 25} if success else None  # noqa: E501
            )
        ...
        analytics = tracker.get_flavor_analytics("analytics-flavor", days_back=30)  # noqa: E501
        ...
        assert analytics_data["selection_rate"] == 2/3  # 2/3 successful executions  # noqa: E501

        # Test with different days_back parameter
        analytics_short = tracker.get_flavor_analytics("analytics-flavor", days_back=1)  # noqa: E501
    ...
    def test_execution_details_endpoint_still_works(self, mock_get_session):
        ...
        test_request = Mock()
        test_request.model_dump.return_value = {"term": "execution_details_test"}  # noqa: E501
        ...
        tracker.complete_execution(
            ...
            success=True,
            token_usage={"input_tokens": 12, "output_tokens": 18, "total_tokens": 30},  # noqa: E501
            start_time=1000000000.0
        )
        ...
        assert details["execution"]["status"] == "success"
        assert details["execution"]["response_message"] == "Details test response"  # noqa: E501
