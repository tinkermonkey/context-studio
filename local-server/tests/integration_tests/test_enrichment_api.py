...
class TestEnrichmentAPIIntegration:
    ...
    def test_dbpedia_search_endpoint_success(self, client):
        ...
        with patch('enrichment.service.EnrichmentService.dbpedia_search') as mock_search:
    ...
    def test_dbpedia_resource_endpoint_success(self, client):
        ...
        with patch('enrichment.service.EnrichmentService.dbpedia_get_resource') as mock_resource:
    ...
    def test_dbpedia_sparql_endpoint_success(self, client):
        ...
        with patch('enrichment.service.EnrichmentService.dbpedia_sparql') as mock_sparql:
    ...
    def test_conceptnet_query_endpoint_success(self, client):
        ...
        with patch('enrichment.service.EnrichmentService.conceptnet_query') as mock_query:
    ...
    def test_conceptnet_concept_endpoint_success(self, client):
        ...
        with patch('enrichment.service.EnrichmentService.conceptnet_get_concept') as mock_concept:
            ...
            response = client.get("/api/nlp_analysis/reference/conceptnet/concept/c/en/apple")
    ...
    def test_conceptnet_related_endpoint_success(self, client):
        ...
        with patch('enrichment.service.EnrichmentService.conceptnet_get_related') as mock_related:
    ...
    def test_wikidata_sparql_endpoint_success(self, client):
        ...
        with patch('enrichment.service.EnrichmentService.wikidata_sparql') as mock_sparql:
            mock_sparql.return_value = {
                "success": True,
                "source": "wikidata",
                "results": {
    ...
    def test_wikidata_entity_endpoint_success(self, client):
        ...
        with patch('enrichment.service.EnrichmentService.wikidata_get_entity') as mock_entity:
    ...
    def test_schema_org_entity_endpoint_success(self, client):
        ...
        with patch('enrichment.service.EnrichmentService.schema_org_get_entity') as mock_entity:
            mock_entity.return_value = {
                "success": True,
                "source": "schema_org",
                "identifier": "Person",
            ...
            response = client.get("/api/nlp_analysis/reference/schema-org/entity/Person")
    ...
    def test_schema_org_property_endpoint_success(self, client):
        ...
        with patch('enrichment.service.EnrichmentService.schema_org_get_property') as mock_property:
            ...
            response = client.get("/api/nlp_analysis/reference/schema-org/property/name")
    ...
    def test_schema_org_search_endpoint_success(self, client):
        ...
        with patch('enrichment.service.EnrichmentService.schema_org_search') as mock_search:
            mock_search.return_value = {
                "success": True,
                "source": "schema_org",
                "query": "person",
