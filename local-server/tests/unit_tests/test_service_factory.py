...
from services.service_factory import ServiceFactory, ServiceType, ServiceMetrics, CachedServiceEntry
...
class TestServiceFactory:
    ...
    def test_service_factory_initialization(self, service_factory):
        ...
        for service_type in ServiceType:
            ...
            assert isinstance(service_factory._metrics[service_type.value], ServiceMetrics)
    ...
    def test_cache_stats_structure(self, service_factory, mock_db_session):
        ...
        required_keys = ['factory_id', 'cache_ttl_seconds', 'cleanup_interval_seconds',
                        'total_cache_entries', 'cache_entries', 'service_metrics']
        ...
        node_metrics = stats['service_metrics']['node_service']
        required_metric_keys = ['total_created', 'cache_hits', 'cache_misses',
                              'cache_hit_rate_percent', 'avg_creation_time_ms']
    ...
    def test_performance_summary(self, service_factory, mock_db_session):
        ...
        required_keys = ['factory_id', 'overall_cache_hit_rate_percent', 
                        'total_services_created', 'total_cache_entries',
                        'best_performing_service', 'worst_performing_service']
        for key in required_keys:
    ...
    def test_health_status(self, service_factory):
        ...
        required_keys = ['factory_id', 'status', 'issues', 'cache_size', 
                        'last_cleanup_age_seconds', 'checked_at']
        for key in required_keys:
    ...
    def test_llm_service_caching_with_parameters(self, service_factory):
        ...
        llm1 = service_factory.create_llm_service(model_name="gpt-3.5-turbo", temperature=0.0)
        llm2 = service_factory.create_llm_service(model_name="gpt-3.5-turbo", temperature=0.5)
        llm3 = service_factory.create_llm_service(model_name="gpt-3.5-turbo", temperature=0.0)  # Same as llm1
    ...
    def test_error_handling_during_service_creation(self, mock_logger, service_factory, mock_db_session):
