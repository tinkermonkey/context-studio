...
class TestDiffGenerator:
    ...
    def test_generate_diff_with_ignore_keys(self, managers, sample_content_v1, sample_content_v2):
    ...
    def test_generate_version_diff(self, managers, sample_content_v1, sample_content_v2):
    ...
    def test_generate_version_diff_nonexistent_version(self, managers, sample_content_v1):
        ...
        with pytest.raises(ValueError, match="After version 2 not found"):
            diff_generator.generate_version_diff(
                'structure_node', 'test-123', 1, 2
            )
        ...
        with pytest.raises(ValueError, match="Before version 5 not found"):
            diff_generator.generate_version_diff(
                'structure_node', 'test-123', 5, 1
            )
    
    def test_generate_working_diff(self, managers, sample_content_v1, sample_content_v2):
    ...
    def test_generate_all_working_diffs(self, managers, sample_content_v1, sample_content_v2):
    ...
    def test_generate_commit_preview(self, managers, sample_content_v1, sample_content_v2):
        ...
        for i in range(2):
            ...
            working_tree_manager.update_current_version('structure_node', entity_id, version2.id)
    ...
    def test_get_change_summary(self, managers, sample_content_v1, sample_content_v2):
        ...
        working_tree_manager.update_current_version('structure_node', 'test-123', version2.id)
    ...
    def test_format_diff_for_display_summary(self, managers, sample_content_v1, sample_content_v2):
    ...
    def test_format_diff_for_display_detailed(self, managers, sample_content_v1, sample_content_v2):
    ...
    def test_format_diff_for_display_json(self, managers, sample_content_v1, sample_content_v2):
    ...
    def test_format_diff_for_display_invalid_format(self, managers, sample_content_v1):
        ...
        diff = diff_generator.generate_version_diff('structure_node', 'test-123', None, 1)
