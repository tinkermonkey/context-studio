...
class TestNodeServiceValidation:
    ...
    def test_domain_validation_unique_title_within_layer(self, node_service, sample_domain_data, mock_db):
        ...
        with pytest.raises(ValueError, match="Domain title must be unique within layer"):
            node_service.create_node(sample_domain_data)
...
class TestCircularReferenceValidation:
    ...
    def test_circular_reference_prevention_indirect(self, node_service, mock_db):
        ...
        with pytest.raises(ValueError, match="Operation would create circular reference"):
...
class TestTitleUniquenessValidation:
    ...
    def test_check_title_uniqueness_exclude_id(self, node_service, mock_db):
        ...
        node_service._get_all_terms_in_domain = Mock(return_value=[exclude_id, str(uuid.uuid4())])
