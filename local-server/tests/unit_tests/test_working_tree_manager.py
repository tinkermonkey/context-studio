...
from services.working_tree_manager import WorkingTreeManager, WorkingTreeEntry, WorkingTreeStatus
...
class TestWorkingTreeManager:
    ...
    def test_initialize_entity_missing_parameters(self, managers):
        ...
        with pytest.raises(ValueError, match="entity_id and initial_version_id are required"):
            working_tree_manager.initialize_entity_in_working_tree(
    ...
    def test_stage_entity(self, managers, sample_content):
        ...
        entry = working_tree_manager.get_working_tree_entry('structure_node', 'test-123')
    ...
    def test_get_working_tree_entry_not_found(self, managers):
        ...
        entry = working_tree_manager.get_working_tree_entry('structure_node', 'non-existent')
    ...
    def test_commit_staged_changes(self, managers, sample_content):
        ...
        for entity_id, expected_version_id in staged_entities:
            entry = working_tree_manager.get_working_tree_entry('structure_node', entity_id)
            assert entry.staged is False
