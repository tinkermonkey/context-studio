...
class TestVersionManager:
    ...
    def test_create_version_missing_required_fields(self, version_manager, sample_content):
    ...
    def test_get_current_version(self, version_manager, sample_content):
        ...
        # Get current version
        current_version = version_manager.get_current_version('structure_node', 'test-123')
    ...
    def test_get_current_version_no_versions(self, version_manager):
        ...
        current_version = version_manager.get_current_version('structure_node', 'non-existent')
    ...
    def test_get_versions_by_state(self, version_manager, sample_content):
        ...
        version_manager.update_version_state(version1.id, ChangeState.STAGED, 'test-user')
