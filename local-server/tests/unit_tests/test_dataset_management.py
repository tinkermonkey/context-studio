...
class TestDatasetManager:
    ...
    def setup_method(self):
        ...
        self.manager = DatasetManager(
            datasets_config_path=self.config_path,
    ...
    def test_create_dataset(self):
        ...
        assert dataset.schema_version == 5  # Should match current migration target version
    ...
    def test_duplicate_title_error(self):
        ...
        with pytest.raises(ValueError, match="Dataset with title 'Test Dataset' already exists"):
    ...
    def test_duplicate_filename_error(self):
        ...
        with pytest.raises(ValueError, match="Dataset with filename 'test.db' already exists"):
    ...
    def test_add_existing_dataset(self):
        ...
        added_dataset = self.manager.add_existing_dataset("External Dataset", external_file)
