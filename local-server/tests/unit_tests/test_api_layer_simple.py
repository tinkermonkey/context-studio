...
def test_api_layer_requirements():
    ...
    for expected_path, expected_methods in expected_routes:
        route_found = any(path == expected_path and set(methods) >= set(expected_methods) 
...
def test_10_1_4_compliance():
    ...
    required_fields = [
        "term", "domain_title", "domain_definition", "parent_term_title", 
        "parent_term_definition", "parent_relationship_predicate", 
        "component_terms", "current_definition", "dbpedia_context"
    ]
