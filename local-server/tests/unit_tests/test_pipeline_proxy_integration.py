...
class TestPipelineProxyIntegration:
    ...
    @patch('nlp.pipeline.get_proxy_manager')
    @patch('nlp.pipeline.spacy.load')
    def test_add_concepcy_component_with_proxy(self, mock_spacy_load, mock_get_proxy_manager, mock_get_config_manager, mock_get_settings):
    ...
    @patch('nlp.pipeline.get_proxy_manager')
    @patch('nlp.pipeline.spacy.load')
    def test_add_dbpedia_component_without_proxy(self, mock_spacy_load, mock_get_proxy_manager, mock_get_config_manager, mock_get_settings):
        ...
        mock_dbpedia_spotlight_config.upstream_url = "https://api.dbpedia-spotlight.org/en/"
