...
def test_text_similarity():
    ...
    with patch('rag.rag_pipeline_service.KGContextProcessor'), \
         patch('rag.rag_pipeline_service.LLMExtractionProcessor'), \
         patch('rag.rag_pipeline_service.SpaCyGapProcessor'), \
         patch('rag.rag_pipeline_service.ConceptResolutionProcessor'), \
         patch('rag.rag_pipeline_service.RAGObservabilityStore'):
