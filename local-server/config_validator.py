...
class ConfigurationValidator:
    ...
    def _add_result(
        ...
        self.results.append(
            ValidationResult(passed, category, test_name, message, details)
        )
    ...
    def _validate_configuration_model(self):
        ...
        try:
            ...
            self._add_result(
                True, category, "import_settings", "Settings model imports successfully"
            )
            ...
            self._add_result(
                ...
                category,
                "create_settings",
                "Settings model instantiates successfully",
            )
            ...
            self._add_result(
                ...
                category,
                "configuration_model",
                f"Configuration model validation failed: {e}",
            )
    ...
    def _validate_configuration_manager(self):
        ...
        try:
            ...
            self._add_result(
                ...
                category,
                "instantiation",
                "Configuration manager instantiates successfully",
            )
            ...
            try:
                ...
                self._add_result(
                    ...
                    category,
                    "get_operation",
                    f"Get operation works (server.host = {server_host})",
                )
            except Exception as e:
                self._add_result(
                    False, category, "get_operation", f"Get operation failed: {e}"
                )
                ...
                if success:
                    ...
                    if new_value == test_value:
                        ...
                        self._add_result(
                            ...
                            category,
                            "set_operation",
                            "Set operation doesn't persist correctly",
                        )
                else:
                    self._add_result(
                        False,
                        category,
                        "set_operation",
                        "Set operation returned failure",
                    )
            except Exception as e:
                self._add_result(
                    False, category, "set_operation", f"Set operation failed: {e}"
                )
            ...
            try:
                ...
                if isinstance(errors, list):
                    self._add_result(
                        ...
                        category,
                        "validation",
                        f"Validation works ({len(errors)} errors found)",
                    )
                else:
                    self._add_result(
                        False,
                        category,
                        "validation",
                        "Validation doesn't return a list",
                    )
            except Exception as e:
                self._add_result(
                    False, category, "validation", f"Validation failed: {e}"
                )
            ...
            self._add_result(
                ...
                f"Configuration manager validation failed: {e}",
            )
    ...
    def _validate_configuration_persistence(self):
        ...
        try:
            ...
            if success:
                self._add_result(
                    True, category, "save_operation", "Configuration saves successfully"
                )
            else:
                self._add_result(
                    False, category, "save_operation", "Configuration save failed"
                )
            ...
            try:
                test_manager.load()
                self._add_result(
                    True, category, "load_operation", "Configuration loads successfully"
                )
            except Exception as e:
                self._add_result(
                    False, category, "load_operation", f"Configuration load failed: {e}"
                )
            ...
            if os.path.exists(test_config_file):
                ...
                self._add_result(
                    False, category, "file_creation", "Configuration file not created"
                )
            ...
            self._add_result(
                ...
                f"Persistence validation failed: {e}",
            )
    ...
    def _validate_configuration_api(self):
        ...
        try:
            ...
            self._add_result(
                True, category, "api_import", "Configuration API imports successfully"
            )
            ...
            for endpoint in required_endpoints:
                ...
                found = any(
                    endpoint in path or path in endpoint for path in endpoint_paths
                )
                if not found:
            ...
            self._add_result(
                False, category, "configuration_api", f"API validation failed: {e}"
            )
        ...
        try:
            ...
            try:
                ...
                self._add_result(
                    ...
                    category,
                    "access_reference_sources",
                    f"Reference sources access failed: {e}",
                )
            ...
            try:
                ...
                self._add_result(
                    ...
                    category,
                    "update_reference_source",
                    f"Reference source update failed: {e}",
                )
    ...
    def _validate_nlp_pipeline_integration(self):
        ...
        try:
            ...
            try:
                ...
                if spec is not None:
                    self._add_result(
                        True,
                        category,
                        "invalidate_pipeline_function",
                        "Pipeline invalidation function exists",
                    )
                else:
                    self._add_result(
                        False,
                        category,
                        "invalidate_pipeline_function",
                        "Pipeline invalidation function not found",
                    )
            ...
            try:
                ...
                if nlp_config:
                    ...
                    self._add_result(
                        ...
                        category,
                        "nlp_config_access",
                        "NLP configuration not accessible",
                    )
            except Exception as e:
                self._add_result(
                    False,
            ...
            self._add_result(
                False,
                category,
                "nlp_pipeline_integration",
                f"NLP integration validation failed: {e}",
            )
        ...
        try:
            ...
            try:
                ...
                if reference_api_spec is not None and api_reference_spec is not None:
                    ...
                    self._add_result(
                        ...
                        category,
                        "reference_imports",
                        "Reference service imports successfully",
                    )
                else:
                    self._add_result(
                        False,
                        category,
                        "reference_imports",
                        "Reference service modules not found",
                    )
                    return
                ...
                self._add_result(
                    ...
                    category,
                    "reference_imports",
                    f"Reference service import failed: {e}",
                )
                return
            ...
            try:
                ...
                self._add_result(
                    ...
                    "Reference service instantiates with ConfigurationManager",
                )
            except Exception as e:
                self._add_result(
                    False,
                    category,
                    "reference_instantiation",
                    f"Reference service instantiation failed: {e}",
                )
            ...
            try:
                ...
                if isinstance(enabled_sources, list):
                    ...
                    self._add_result(
                        ...
                        category,
                        "get_enabled_sources",
                        "get_enabled_sources doesn't return list",
                    )
            except Exception as e:
                self._add_result(
                    False,
                    category,
                    "get_enabled_sources",
                    f"get_enabled_sources failed: {e}",
                )
            ...
            self._add_result(
                False,
                category,
                "reference_service_integration",
                f"Reference integration validation failed: {e}",
            )
    ...
    def generate_report(self) -> str:
        ...
        for category, results in categories.items():
            ...
            report.append(
                f"  Category Summary: {category_passed}/{category_total} tests passed"
            )

        report.append("\n" + "=" * 80)
        if failed_tests == 0:
            report.append(
                "🎉 ALL VALIDATIONS PASSED! Configuration system is ready for use."
            )
        else:
            report.append(
                f"⚠️  {failed_tests} validation(s) failed. Review and fix issues before proceeding."
            )
        report.append("=" * 80)
