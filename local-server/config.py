...
class DatabaseConfig(BaseModel):
    ...
    default_url: str = Field(  # noqa: E501
        default="sqlite:///./datafiles/local.db",
...
class NLPConfig(BaseModel):
    ...
    model_name: str = Field(default="en_core_web_lg", description="spaCy model name")  # noqa: E501
    max_text_length: int = Field(default=512, ge=1, le=10000, description="Maximum text length for analysis")  # noqa: E501
    sense2vec_path: str = Field(default="./downloads/s2v_reddit_2015_md", description="Sense2Vec model path")  # noqa: E501
    concepcy_relations: List[str] = Field(default=["RELATED_TO", "IS_A", "PART_OF"], description="List of ConceptNet relations to use")  # noqa: E501
    filter_missing_text: bool = Field(default=True, description="Whether to filter out missing text")  # noqa: E501
    edge_weight_filter: float = Field(default=2.0, ge=0.0, description="Minimum edge weight for filtering")  # noqa: E501
    request_timeout: int = Field(default=30, ge=1, description="Request timeout in seconds")  # noqa: E501

    # Model auto-download settings
    auto_download_models: bool = Field(default=True, description="Automatically download missing NLP models on startup")  # noqa: E501
    download_timeout: int = Field(default=600, ge=60, le=1800, description="Timeout for model downloads in seconds")  # noqa: E501
...
class RAGPipelineConfig(BaseModel):
    ...
    kg_context_top_k: int = Field(default=50, ge=1, le=1000, description="Top-k results for knowledge graph context retrieval")  # noqa: E501
    kg_vector_threshold: float = Field(default=0.6, ge=0.0, le=1.0, description="Minimum similarity threshold for vector search in knowledge graph (Layer 0 and Layer 3)")  # noqa: E501

    # RAG Pipeline layer timeouts (in seconds)
    timeout_layer_0: float = Field(default=1.0, ge=0.1, le=60.0, description="Timeout for Layer 0 (KG context preparation) in seconds")  # noqa: E501
    timeout_layer_1: float = Field(default=30.0, ge=1.0, le=300.0, description="Timeout for Layer 1 (LLM extraction) in seconds")  # noqa: E501
    timeout_layer_2: float = Field(default=0.5, ge=0.1, le=60.0, description="Timeout for Layer 2 (spaCy gap detection) in seconds")  # noqa: E501
    timeout_layer_3: float = Field(default=30.0, ge=1.0, le=300.0, description="Timeout for Layer 3 (concept resolution) in seconds")  # noqa: E501

    # LLM pipeline settings
    llm_pipeline_flavor: Optional[str] = Field(default=None, description="LLM pipeline flavor to use for RAG operations")  # noqa: E501
    llm_timeout: int = Field(default=30, ge=1, le=300, description="LLM request timeout in seconds (deprecated: use timeout_layer_1 instead)")  # noqa: E501
    enable_llm_layer: bool = Field(default=True, description="Enable Layer 1 LLM extraction (can be disabled for testing or cost reduction)")  # noqa: E501

    # Gap detection settings
    gap_detection_deps: List[str] = Field(default_factory=list, description="Dependencies for gap detection layer")  # noqa: E501

    # Web search settings
    web_search_enabled: bool = Field(default=True, description="Enable web search for gap filling")  # noqa: E501
    web_search_max_attempts: int = Field(default=3, ge=1, le=10, description="Maximum web search attempts per query")  # noqa: E501
    web_search_rate_limit: int = Field(default=5, ge=1, le=100, description="Web search rate limit (searches per minute)")  # noqa: E501
    web_search_max_per_session: int = Field(default=10, ge=1, le=100, description="Maximum web searches per session")  # noqa: E501

    # Observability settings
    enable_observability: bool = Field(default=True, description="Enable observability and metrics collection")  # noqa: E501
    observability_retention_days: int = Field(default=30, ge=1, le=365, description="Retention period for metrics data in days")  # noqa: E501
    trace_retention_days: int = Field(default=7, ge=1, le=90, description="Retention period for trace data in days")  # noqa: E501
    trace_max_data_size_kb: int = Field(default=100, ge=1, le=10000, description="Maximum size of trace data per request in KB")  # noqa: E501

    # Deduplication settings
    deduplication_threshold: float = Field(default=0.9, ge=0.0, le=1.0, description="Similarity threshold for entity deduplication")  # noqa: E501

    # Extraction decision thresholds
    extraction_confidence_threshold: float = Field(default=0.7, ge=0.0, le=1.0, description="Minimum confidence threshold for entity extraction")  # noqa: E501


class ReferenceSourceRateLimitConfig(BaseModel):
    """Rate limiting configuration for a specific reference source"""
    requests_per_hour: int = Field(default=1000, ge=1, description="Requests per hour limit")  # noqa: E501
    requests_per_minute: Optional[int] = Field(default=None, ge=1, description="Requests per minute limit (optional)")  # noqa: E501
    requests_per_second: Optional[int] = Field(default=None, ge=1, description="Requests per second limit (optional)")  # noqa: E501
    progressive_delay: bool = Field(default=True, description="Enable progressive delay on rate limit")  # noqa: E501
    max_delay: int = Field(default=300, ge=1, description="Maximum delay in seconds")  # noqa: E501


class ReferenceSourceConfig(BaseModel):
    """Configuration for a specific reference source"""
    enabled: bool = Field(default=True, description="Enable this reference source")  # noqa: E501
    upstream_url: str = Field(..., description="Upstream API URL for this source")  # noqa: E501
    use_proxy: bool = Field(default=True, description="Route requests through caching proxy")  # noqa: E501
    timeout: int = Field(default=30, ge=1, le=300, description="Request timeout in seconds")  # noqa: E501
    max_retries: int = Field(default=3, ge=0, le=10, description="Maximum retry attempts")  # noqa: E501
    rate_limit: ReferenceSourceRateLimitConfig = Field(default_factory=ReferenceSourceRateLimitConfig)  # noqa: E501

    # Source-specific configuration overrides
    custom_headers: Dict[str, str] = Field(default_factory=dict, description="Custom headers for requests")  # noqa: E501
    custom_params: Dict[str, str] = Field(default_factory=dict, description="Custom query parameters")  # noqa: E501
...
class ReferenceSourcesConfig(BaseModel):
    ...
    default_language: str = Field(default="en", description="Default language code for all reference source queries")  # noqa: E501

    # Global search timeout for multi-source search operations
    search_timeout: int = Field(default=30, ge=5, le=300, description="Timeout in seconds for multi-source search operations")  # noqa: E501

    # Reference link filtering settings
    enable_relevance_filtering: bool = Field(default=False, description="Enable predicate relevance filtering for reference queries by default")  # noqa: E501
    filter_cache_ttl: int = Field(default=300, ge=60, le=3600, description="Cache TTL for predicate relevance filters in seconds")  # noqa: E501

    # Individual source configurations
    conceptnet: ReferenceSourceConfig = Field(default_factory=lambda: ReferenceSourceConfig(  # noqa: E501
    ...
    dbpedia_lookup: ReferenceSourceConfig = Field(default_factory=lambda: ReferenceSourceConfig(  # noqa: E501
    ...
    dbpedia_sparql: ReferenceSourceConfig = Field(default_factory=lambda: ReferenceSourceConfig(  # noqa: E501
    ...
    dbpedia_spotlight: ReferenceSourceConfig = Field(default_factory=lambda: ReferenceSourceConfig(  # noqa: E501
    ...
    wikidata: ReferenceSourceConfig = Field(default_factory=lambda: ReferenceSourceConfig(  # noqa: E501
    ...
    duckduckgo: ReferenceSourceConfig = Field(default_factory=lambda: ReferenceSourceConfig(  # noqa: E501
    ...
    schema_org: ReferenceSourceConfig = Field(default_factory=lambda: ReferenceSourceConfig(  # noqa: E501
        upstream_url="https://schema.org",
        use_proxy=False,  # Local database, no proxy needed
        timeout=10,
        max_retries=1,
        rate_limit=ReferenceSourceRateLimitConfig(requests_per_hour=10000)  # Local, no real limit  # noqa: E501
    ))
    ...
    openai: ReferenceSourceConfig = Field(default_factory=lambda: ReferenceSourceConfig(  # noqa: E501
    ...
    anthropic: ReferenceSourceConfig = Field(default_factory=lambda: ReferenceSourceConfig(  # noqa: E501
...
class ProxyServerConfig(BaseModel):
    ...
    port: int = Field(default=18080, ge=1024, le=65535, description="Proxy server port")  # noqa: E501
    enabled: bool = Field(default=True, description="Enable proxy server globally")  # noqa: E501
    database_path: str = Field(default="./datafiles/reference_api_cache.db", description="Cache database path")  # noqa: E501
    max_cache_entries: int = Field(default=10000, ge=100, description="Maximum total cache entries")  # noqa: E501

    # Global cache defaults (can be overridden per source)
    default_cache_ttl: int = Field(default=3600, ge=60, description="Default cache TTL (seconds)")  # noqa: E501
    default_max_response_size: int = Field(default=10485760, ge=1024, description="Default maximum cached response size (bytes)")  # noqa: E501

    # Global rate limiting defaults
    default_requests_per_hour: int = Field(default=1000, ge=1, description="Default requests per hour")  # noqa: E501
    progressive_max_delay: int = Field(default=300, ge=1, description="Default maximum progressive delay (seconds)")  # noqa: E501


class LoggingConfig(BaseModel):
    """Logging configuration section"""
    level: LogLevel = Field(default=LogLevel.INFO, description="Log level")
    enable_console: bool = Field(default=False, description="Enable console logging")  # noqa: E501
    enable_file: bool = Field(default=True, description="Enable file logging")
    file_path: str = Field(default="./logs/context_studio.log", description="Log file path")  # noqa: E501
    format: str = Field(default="%(asctime)s - %(name)s - %(levelname)s - %(message)s", description="Log format")  # noqa: E501
    date_format: str = Field(default="%Y-%m-%d %H:%M:%S", description="Date format")  # noqa: E501
    max_file_size: int = Field(default=10485760, ge=1024, description="Maximum log file size (bytes)")  # noqa: E501
    backup_count: int = Field(default=5, ge=0, description="Number of backup files")  # noqa: E501


class SecurityConfig(BaseModel):
    """Security configuration section"""
    require_secure_key: bool = Field(default=False, description="Require secure key for proxy")  # noqa: E501
    secure_key: Optional[str] = Field(default=None, description="Secure key for proxy access")  # noqa: E501
    log_security_events: bool = Field(default=False, description="Log security events")  # noqa: E501
    api_key_header: str = Field(default="X-API-Key", description="API key header name")  # noqa: E501
...
class SourceConfig(BaseModel):
    ...
    use_proxy: bool = Field(True, description="Whether to use caching proxy for this source")  # noqa: E501
    timeout: int = Field(30, ge=1, le=300, description="Request timeout in seconds")  # noqa: E501
    max_retries: int = Field(3, ge=0, le=10, description="Maximum number of retries")  # noqa: E501
    base_url: Optional[str] = Field(None, description="Override base URL for source")  # noqa: E501
...
class Settings(BaseModel):
    ...
    reference_sources: ReferenceSourcesConfig = Field(default_factory=ReferenceSourcesConfig)  # noqa: E501
    ...
    def get_enabled_sources(self) -> List[str]:
        ...
        enabled = []
        for source_name in ["conceptnet", "dbpedia_lookup", "dbpedia_sparql", "dbpedia_spotlight", "wikidata", "schema_org"]:  # noqa: E501
    ...
    def get_concepcy_config(self, use_proxy: bool = False) -> dict:
        ...
        if use_proxy and self.proxy_server.enabled:
            ...
            config["url"] = f"http://{host}:{port}/conceptnet/query?node=/c/{{lang}}/{{word}}&other=/c/{{lang}}"  # noqa: E501
        return config
    ...
    def get_reference_api_buddy_config(self) -> dict:
        ...
        for source_name in self.get_proxy_enabled_sources():
            ...
            legacy_keys = {
                ...
                "dbpedia_spotlight": ["spacy_dbpedia_spotlight", "dbpedia_spotlight"],  # noqa: E501
                "dbpedia_lookup": ["dbpedia", "dbpedia_lookup"],  # Map dbpedia_lookup to legacy 'dbpedia' key  # noqa: E501
...
class ConfigurationManager:
    ...
    def __init__(self, config_file: str = "./config.json"):
        ...
        print(f"[ConfigurationManager] Loading config from: {self.config_file}")  # noqa: E501
        self.load()
    ...
    def load(self) -> Settings:
        ...
        if os.path.exists(self.config_file) and os.path.getsize(self.config_file) > 0:  # noqa: E501
            with open(self.config_file, 'r') as f:
                config_data = json.load(f)

            self.settings = Settings(**config_data)
            print(f"[ConfigurationManager] Config loaded successfully from {self.config_file}")  # noqa: E501
            print(f"[ConfigurationManager] Server port: {self.settings.server.port}")  # noqa: E501
            print(f"[ConfigurationManager] Database URL: {self.settings.database.default_url}")  # noqa: E501
        else:
            print(f"[ConfigurationManager] Config file not found or empty: {self.config_file}, using defaults")  # noqa: E501
    ...
    def save(self) -> bool:
        ...
        try:
            ...
            print(f"Error saving config: {e}")  # Use print to avoid circular dependency  # noqa: E501
            return False
    ...
    def get(self, path: str) -> Any:
        ...
        try:
            ...
            print(f"Error getting config value {path}: {e}")  # Use print to avoid circular dependency  # noqa: E501
            raise
    ...
    def set(self, path: str, value: Any) -> bool:
        ...
        try:
            with self._lock:
                ...
                for part in parts[:-1]:
                    if hasattr(obj, part):
                        ...
                        raise KeyError(f"Configuration path not found: {'.'.join(parts[:-1])}")  # noqa: E501
            ...
            print(f"Error setting config value {path}: {e}")  # Use print to avoid circular dependency  # noqa: E501
            return False
    ...
    async def update_reference_source(self, source_name: str, update_data: Dict[str, Any]):  # noqa: E501
...
async def handle_reference_source_config_change(path: str, value: Any):
    ...
    if path.startswith("reference_sources."):
        ...
        if len(parts) >= 2:
            ...
            if source_name in ["conceptnet", "dbpedia_spotlight"] and field in ["enabled", "use_proxy", "upstream_url"]:  # noqa: E501
                try:
                    from nlp.pipeline import invalidate_pipeline
                    invalidate_pipeline()
                except ImportError:
...
_config_notifier.register_listener("reference_sources.", handle_reference_source_config_change)  # noqa: E501
