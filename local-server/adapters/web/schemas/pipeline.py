...
class PipelineConfigurationCreate(BaseModel):
    ...
    pipeline: str = Field(..., description="Pipeline identifier/slug for categorization", min_length=1)
    ...
    system_prompt: str = Field(..., description="System prompt to guide model behavior", min_length=1)
    user_prompt: str = Field(..., description="User message template with {text} placeholder", min_length=1)
