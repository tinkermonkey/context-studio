...
async def get_metrics_database(
    service: AdminService = Depends(get_admin_service),
) -> DatabaseHealthResponse:
    """
    Get database component health metrics.
...
async def get_metrics_services(
    service: AdminService = Depends(get_admin_service),
) -> ServiceMetricsResponse:
    """
    Get service-level metrics.
...
async def get_metrics_embedding(
    service: AdminService = Depends(get_admin_service),
) -> ComponentStatusResponse:
    """
    Get embedding model component metrics.
...
async def get_metrics_nlp(
    service: AdminService = Depends(get_admin_service),
) -> ComponentStatusResponse:
    """
    Get NLP pipeline component metrics.
