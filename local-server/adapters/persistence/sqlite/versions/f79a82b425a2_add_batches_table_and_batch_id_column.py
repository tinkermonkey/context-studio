...
def upgrade() -> None:
    op.create_table('batches',
        ...
        sa.CheckConstraint("status IN ('pending', 'running', 'completed', 'failed', 'cancelled')", name='check_valid_batch_status'),
    ...
    with op.batch_alter_table('batch_runs', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('fk_batch_runs_batch_id', 'batches', ['batch_id'], ['id'], ondelete='CASCADE')
