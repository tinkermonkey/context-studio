...
def upgrade() -> None:
    ...
    op.add_column('ontology_entities', sa.Column('title_embedding', sa.LargeBinary(), nullable=True))
    op.add_column('ontology_entities', sa.Column('definition_embedding', sa.LargeBinary(), nullable=True))
