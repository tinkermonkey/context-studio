...
This module provides administrative endpoints for monitoring the Enhanced Event Processor  # noqa: E501
...
async def get_event_processor_health(request: Request) -> Dict[str, Any]:
    ...
    try:
        ...
        if hasattr(processor, 'get_health_status'):
            ...
            stats = processor.get_stats() if hasattr(processor, 'get_stats') else {}  # noqa: E501
            return {
                "status": "running" if stats.get("is_running", False) else "stopped",  # noqa: E501
                "timestamp": datetime.now().isoformat(),
        ...
        raise HTTPException(status_code=500, detail=f"Health check failed: {str(e)}")  # noqa: E501
...
async def get_event_processor_stats(request: Request) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            "timestamp": datetime.now().isoformat(),
            "processor_type": "enhanced" if hasattr(processor, 'db_manager') else "legacy",  # noqa: E501
            "enhanced_available": True,
            "stats": stats
        }

    except Exception as e:
        raise HTTPException(status_code=500, detail=f"Stats retrieval failed: {str(e)}")  # noqa: E501


@router.get("/admin/events/performance", summary="Event Processing Performance Metrics")  # noqa: E501
    ...
    try:
        ...
        performance_data = {
            ...
            "event_metrics": {
                ...
                "total_processed": stats.get("events_processed_total", stats.get("processed_count", 0)),  # noqa: E501
        ...
        raise HTTPException(status_code=500, detail=f"Performance metrics failed: {str(e)}")  # noqa: E501


@router.get("/admin/events/database", summary="Event Processor Database Status")  # noqa: E501
async def get_event_processor_database_status(request: Request) -> Dict[str, Any]:  # noqa: E501
    ...
    try:
        ...
        if hasattr(processor, 'db_manager'):
            ...
            # Legacy processor
            result.update({
                "database_health": {"status": "unknown", "message": "Legacy processor - limited health monitoring"},  # noqa: E501
        ...
        raise HTTPException(status_code=500, detail=f"Database status check failed: {str(e)}")  # noqa: E501
...
async def restart_event_processor(request: Request) -> Dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Restart failed: {str(e)}")  # noqa: E501


@router.get("/admin/events/recommendations", summary="Event Processor Performance Recommendations")  # noqa: E501
async def get_event_processor_recommendations(request: Request) -> Dict[str, Any]:  # noqa: E501
    ...
    try:
        ...
        if not stats.get("is_running", False):
            recommendations.append("❌ Event processor is not running - restart required")  # noqa: E501
        ...
        if is_enhanced:
            ...
            if db_metrics.get("pool_efficiency_percent", 100) < 80:
                recommendations.append("📊 Database pool efficiency is low - consider adjusting pool configuration")  # noqa: E501

            if db_metrics.get("avg_query_time_ms", 0) > 10:
                recommendations.append("⏱️ Database query times are high - check database performance")  # noqa: E501
        ...
        raise HTTPException(status_code=500, detail=f"Recommendations failed: {str(e)}")  # noqa: E501
...
async def get_event_processor_dashboard(request: Request) -> Dict[str, Any]:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Dashboard data failed: {str(e)}")  # noqa: E501
