...
class IntelligentQueryCache:
    ...
    def __init__(self, max_cache_size: int = 1000, ttl_seconds: int = 3600):
        ...
        logger.info(f"IntelligentQueryCache initialized with max_size={max_cache_size}, ttl={ttl_seconds}s")
...
class DuckDBQueryOptimizer:
    ...
    def __init__(self, duckdb_conn: duckdb.DuckDBPyConnection, s3_config: Dict[str, str]):
        ...
        logger.info("DuckDBQueryOptimizer initialized with advanced optimization features")
    ...
    def optimize_query(self, query: str, query_context: Dict[str, Any] = None) -> Tuple[str, QueryPerformanceMetrics]:
        ...
        if metrics.execution_time_ms < 10000:  # Cache queries under 10s
            self.query_cache.cache_result(query_hash, {
    ...
    def _optimize_aggregation_pushdown(self, query: str, context: Dict[str, Any]) -> str:
    ...
    def _measure_query_performance(self, query: str, query_id: str) -> QueryPerformanceMetrics:
        ...
        return {
            ...
            'materialized_views': {
                name: {
                    ...
                    'last_refreshed': datetime.fromtimestamp(view['last_refreshed']).isoformat(),
