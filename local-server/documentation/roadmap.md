...
1. RAG w/ DataNodes & StructureNodes
...
1. Config management UX

1. Improved Dashboard with recent changes
...
1. Litmus tests for disambiguating similar terms

1. Matryoshka embeddings to vector embed a hierarchy of concepts

## Tech Debt

1. Integrate Alembic for managing/facilitating schema migrations