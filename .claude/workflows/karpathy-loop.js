...
function evaluatePrompt() {
  return [
    ...
    '   currently `default`, the RAG-grounded two-pass LLM pipeline on main (dev strict-F1 ~0.66 / soft-F1 ~0.68 on the grounded-only split), which supersedes',
...
function experimentPrompt(hypothesis, evaluation) {
  return [
    ...
    '   reported above (the RAG-grounded `default` leader sits ~0.86 on the grounded-only split; the rule `open_v1` baseline ~0.50) —',
