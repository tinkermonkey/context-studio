...
assistant: "I'll use the rearchitecture-architect agent to design the search capability — domain entities, port interfaces, adapter options, and API operations — before any implementation starts."
<commentary>
...
assistant: "I'll use the rearchitecture-architect agent to produce the full domain model, port catalog, adapter specifications, and API surface for Graph Analysis."
<commentary>
...
assistant: "I'll use the rearchitecture-architect agent to design the bulk import capability within the Ontology context — port additions, domain service changes, adapter, and route — then produce a blueprint for implementation."
<commentary>
...
assistant: "I'll use the rearchitecture-architect agent to design the inter-context interaction pattern, referencing the DR model and rearchitecture docs."
<commentary>
...
### Step 5 — Produce the Design Blueprint
...
### Step 6 — Formally Propose DR Model Changes
...
Ordered checklist the engineer follows — never skip or reorder steps:

- [ ] 1. Add value objects to `value_objects.py`
- [ ] 2. Add domain entities to `entities.py` with invariants
- [ ] 3. Add domain events to `events.py`
- [ ] 4. Update port interface(s) in `ports.py`
- [ ] 5. Write fakes in `tests/fakes/`
- [ ] 6. Write unit tests — verify they pass with fakes
- [ ] 7. Update domain service in `services.py`
- [ ] 8. Update ORM model in `adapters/persistence/sqlite/models.py`
- [ ] 9. Run `alembic revision --autogenerate -m "..."` and review
- [ ] 10. Write repository adapter
- [ ] 11. Write integration tests — verify against real SQLite
- [ ] 12. Write Pydantic schemas
- [ ] 13. Write route handler(s)
- [ ] 14. Wire into composition root (`app.py`)
- [ ] 15. Write route integration tests
- [ ] 16. Run `scripts/update_api_specs.py` and commit `documentation/openapi.json`
- [ ] 17. Run `scripts/check_domain_imports.py` — must exit 0
- [ ] 18. Run `dr-sync` to update the DR model with implemented elements
